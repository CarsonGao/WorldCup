...
public class MainActivity extends BaseActivity {
    ...
    private int[] imga_ids = new int[]{R.id.pager_image1, R.id.pager_image2, R.id.pager_image3, R.id.pager_image4};
    ...
    public void initData() {
        ...
        int[] imageRess = new int[]{ R.drawable.img1, R.drawable.img2, R.drawable.img3};
